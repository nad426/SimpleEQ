...
template<typename ChainType, typename CoefficientType> void updateCutFilter(ChainType& chain, const CoefficientType& cutCoefficient, const Slope& Slope){
    ...
    switch ( Slope ) {
        case Slope_48:
        {
            update<3>(chain, cutCoefficient);
        }
        case Slope_36:
        {
            update<2>(chain, cutCoefficient);
        }
        case Slope_24:
        {
            update<1>(chain, cutCoefficient);
        }
        case Slope_12:
        {
            update<0>(chain, cutCoefficient);
        }
