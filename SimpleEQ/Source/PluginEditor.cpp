...
void ResponseCurveComponent::timerCallback(){
    ...
    */
    ...
    if ( parametersChanged.compareAndSetBool(false, true)){
        ...
        DBG( "params Changed "); // console log
        updateChain();
        //Signal repaint
        /*repaint();*/
    }
...
void ResponseCurveComponent::resized(){
    ...
    auto right = getRenderArea().getRight();
    auto top = getRenderArea().getY();
    auto bottom = getRenderArea().getBottom();
    auto width = getRenderArea().getWidth();
